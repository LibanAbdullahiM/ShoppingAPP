...
const OrderDetailsScreen = ({navigation, route}) => {
    ...
    console.log("USER DATA FROM ORDERDETAILS SCREEN: ", userData)
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <View style={styles.cart_header}>
                    <Text style={[styles.large_txt, {marginTop: 8, marginLeft: 16, marginBottom: 16,}]}>Информация о заказе</Text>
                </View>
            </View>

            <TouchableOpacity onPress={() => navigation.navigate("MyOrders", {userData: userData})} style={styles.cross_icon}>
            ...
            <ScrollView style={styles.scroll} contentContainerStyle={{
                ...
                <View style={{width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start', marginLeft: 32, marginTop: 32,}}>
                    <Text style={[styles.large_txt]}>Информация о заказе</Text>
                </View>
                 ...
                 <View style={{width: '95%', padding: 4, marginTop: 16,  backgroundColor: width < 500 ? '#3b3c3d' : '#fff', justifyContent: 'center', alignItems: 'center', borderRadius: 8,}}>
                    <View style={{width: '90%', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginLeft: 8,}}>
                        <Text style={styles.large_txt}>Оплачено</Text>
                    </View>
                    <View style={{width: '90%', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginLeft: 8, marginTop: 8,}}>
                        <Text style={styles.small_txt}>Товары ({order?.quantities})</Text>
                        <Text style={styles.large_txt}>${order?.totalPrice}</Text>
                    </View>
                    <View style={{width: '90%', justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginLeft: 8, marginTop: 8,}}>

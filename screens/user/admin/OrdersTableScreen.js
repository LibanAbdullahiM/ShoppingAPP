                    ...
                    <ScrollView style={styles.dataWrapper}>
                        {
                            orders.map((order, index) => {
                                return <TableRow key={index} order={order} navigation={navigation}/>
                            })
                        }
                    </ScrollView>
                }
...
export const TableRow = ({order, navigation}) => {

    return (
        <View style={styles.row}>
            <View style={[styles.cel, {width: '9%',}]}>
                <Text style={styles.small_txt}>{order?.id}</Text>
            </View>
            <View style={[styles.cel, {width: '45%',}]}>
            ...
            <TouchableOpacity style={[styles.cel, {width: '15%',}]}>
                <Text style={[styles.small_txt, {color: '#126'}]}>DETAILS</Text>
            </TouchableOpacity>
        </View>
    )
